...
const Dashboard = () => {
  ...
  const uploadResume = async (event) => {
    ...
    try {
      ...
      const id = data.resume?._id || data.resumeId;
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <p className="text-sm group-hover:text-pruple-600 transition-all duration-300">
              Upload Existing
            </p>
          </button>
        </div>
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full px-4 py-2 focus:border-green-600 ring-green-600 mb-4"
                required
              />
