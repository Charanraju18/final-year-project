          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1 ">
              ...
              <button
                ...
                className="bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 transition-all px-6 py-2 rounded-md mt-6 text-sm"
              >
                Save Changes
              </button>
            </div>
            ...
            <div className="relative w-full">
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                {resumeData.public && (
                  <button
                    onClick={handleShare}
                    className="flex items-center gap-2 p-2 px-4 text-xs bg-gradient-to-r from-blue-100 to-blue-200 ring-blue-300 text-blue-600 rounded-lg hover:ring transition-colors"
                  >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2 text-xs bg-gradient-to-br from-green-100 to-green-200 ring-green-300 text-green-600 rounded-lg hover:ring transition-colors"
                >
